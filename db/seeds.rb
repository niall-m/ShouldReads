...
book45 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/firenfury.jpg"
)
book8 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/fahrenheit.jpg"
)
book7 = Book.create!(
    :title => "1984",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/1984.jpeg"
)
book12 = Book.create!(
    :title => "Animal Farm",
    :author => "George Orwell",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/animalfarm.jpg"
)
book18 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/clockworkorange.jpg"
)
book6 = Book.create!(
    :title => "Catch-22",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/catch22.jpg"
)
book24 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/cuckoo.png"
)
book32 = Book.create!(
...
book2 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/greatgatsby.jpg"
)
book3 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/wildthings.jpg"
)
book4 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/bravenewworld.jpg"
)
book5 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/masternmargarita.jpg"
)
book9 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/slaughterhouse5.jpg"
)
book10 = Book.create!(
    :title => "Invisible Man",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/invisibleman.jpg"
)
book11 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/harrypotter1.jpg"
)
book13 = Book.create!(
    :title => "The Alchemist",
    :author => "Paulo Coelho",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/alchemist.jpg"
)
book14 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/sunalsorises.jpg"
)
book16 = Book.create!(
    :title => "Women in Love",
    :author => "D.H. Lawrence",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/womeninlove.jpg"
)
book17 = Book.create!(
    :title => "On the Road",
    :author => "Jack Kerouac",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/ontheroad.jpg"
)
book19 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/heartofdarkness.jpg"
)
book20 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/callofthewild.jpg"
)
book21 = Book.create!(
    :title => "To Kill a Mockingbird",
    :author => "Harper Lee",
    :description => "Compassionate, dramatic, and deeply moving, To Kill A Mockingbird takes readers to the roots of human behavior - to innocence and experience, kindness and cruelty, love and hatred, humor and pathos. Now with over 18 million copies in print and translated into forty languages, this regional story by a young Alabama woman claims universal appeal. Harper Lee always considered her book to be a simple love story. Today it is regarded as a masterpiece of American literature.",
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/killmockingbird.jpg"
)
book22 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/catcherintherye.jpg"
)
book23 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/lordoftheflies.png"
)
book25 = Book.create!(
    :title => "Atonement",
    :author => "Ian McEwan",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/atonement.jpg"
)
book26 = Book.create!(
    :title => "Don Quixote",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/donquixote.jpg"
)
book27 = Book.create!(
    :title => "Shogun",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/shogun.jpg"
)
book28 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/gameofthrones.jpg"
)
book29 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/soundandfury.jpg"
)
book30 = Book.create!(
    :title => "IT",
    :author => "Stephen King",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/it.jpg"
)
book31 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/cryingoflot49.jpg"
)
book33 = Book.create!(
    :title => "Lolita",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/lolita.jpg"
)
book34 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/deathofasalesman.jpg"
)
book35 = Book.create!(
    :title => "The Hobbit",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/hobbit.jpg"
)
book36 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/brotherskaramozov.jpg"
)
book37 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/hitchhikersguide.png"
)
book38 = Book.create!(
    :title => "Life of Pi",
    :author => "Yann Martel",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/lifeofpi.jpg"
)
book39 = Book.create!(
    :title => "Dune",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/dune.jpg"
)
book40 = Book.create!(
    :title => "Jurassic Park",
...
book43 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/sherlock.jpg"
)
book44 = Book.create!(
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/princessbride.jpg"
)
book1 = Book.create!(
    :title => "Ulysses",
    :author => "James Joyce",
    ...
    :cover_img => "//drhktpaw9j8bp.cloudfront.net/ulysses.jpg"
)
