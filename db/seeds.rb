...
book45 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/firenfury.jpg"
)
book8 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/fahrenheit.jpg"
)
book7 = Book.create!(
    :title => "1984",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/1984.jpeg"
)
book12 = Book.create!(
    :title => "Animal Farm",
    :author => "George Orwell",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/animalfarm.jpg"
)
book18 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/clockworkorange.jpg"
)
book6 = Book.create!(
    :title => "Catch-22",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/catch22.jpg"
)
book24 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/cuckoo.png"
)
book32 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/psycho.jpg"
)
book15 = Book.create!(
    :title => "The Secret Agent",
    :author => "Joseph Conrad",
    :description => "Mr Verloc, the secret agent, keeps a shop in London's Soho where he lives with his wife Winnie, her infirm mother, and her idiot brother, Stevie. When Verloc is reluctantly involved in an anarchist plot to blow up the Greenwich Observatory things go disastrously wrong, and what appears to be 'a simple tale' proves to involve politicians, policemen, foreign diplomats and London's fashionable society in the darkest and most surprising interrelations.",
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/secretagent.jpg"
)
book2 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/greatgatsby.jpg"
)
book3 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/wildthings.jpg"
)
book4 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/bravenewworld.jpg"
)
book5 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/masternmargarita.jpg"
)
book9 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/slaughterhouse5.jpg"
)
book10 = Book.create!(
    :title => "Invisible Man",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/invisibleman.jpg"
)
book11 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/harrypotter1.jpg"
)
book13 = Book.create!(
    :title => "The Alchemist",
    :author => "Paulo Coelho",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/alchemist.jpg"
)
book14 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/sunalsorises.jpg"
)
book16 = Book.create!(
    :title => "Women in Love",
    :author => "D.H. Lawrence",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/womeninlove.jpg"
)
book17 = Book.create!(
    :title => "On the Road",
    :author => "Jack Kerouac",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/ontheroad.jpg"
)
book19 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/heartofdarkness.jpg"
)
book20 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/callofthewild.jpg"
)
book21 = Book.create!(
    :title => "To Kill a Mockingbird",
    :author => "Harper Lee",
    :description => "Compassionate, dramatic, and deeply moving, To Kill A Mockingbird takes readers to the roots of human behavior - to innocence and experience, kindness and cruelty, love and hatred, humor and pathos. Now with over 18 million copies in print and translated into forty languages, this regional story by a young Alabama woman claims universal appeal. Harper Lee always considered her book to be a simple love story. Today it is regarded as a masterpiece of American literature.",
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/killmockingbird.jpg"
)
book22 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/catcherintherye.jpg"
)
book23 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/lordoftheflies.png"
)
book25 = Book.create!(
    :title => "Atonement",
    :author => "Ian McEwan",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/atonement.jpg"
)
book26 = Book.create!(
    :title => "Don Quixote",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/donquixote.jpg"
)
book27 = Book.create!(
    :title => "Shogun",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/shogun.jpg"
)
book28 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/gameofthrones.jpg"
)
book29 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/soundandfury.jpg"
)
book30 = Book.create!(
    :title => "IT",
    :author => "Stephen King",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/it.jpg"
)
book31 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/cryingoflot49.jpg"
)
book33 = Book.create!(
    :title => "Lolita",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/lolita.jpg"
)
book34 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/deathofasalesman.jpg"
)
book35 = Book.create!(
    :title => "The Hobbit",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/hobbit.jpg"
)
book36 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/brotherskaramozov.jpg"
)
book37 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/hitchhikersguide.png"
)
book38 = Book.create!(
    :title => "Life of Pi",
    :author => "Yann Martel",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/lifeofpi.jpg"
)
book39 = Book.create!(
    :title => "Dune",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/dune.jpg"
)
book40 = Book.create!(
    :title => "Jurassic Park",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/jurassicpark.jpg"
)
book41 = Book.create!(
    :title => "In Cold Blood",
    :author => "Truman Capote",
    :description => "On November 15, 1959, in the small town of Holcomb, Kansas, four members of the Clutter family were savagely murdered by blasts from a shotgun held a few inches from their faces. There was no apparent motive for the crime, and there were almost no clues. As Truman Capote reconstructs the murder and the investigation that led to the capture, trial, and execution of the killers, he generates both mesmerizing suspense and astonishing empathy. In Cold Blood is a work that transcends its moment, yielding poignant insights into the nature of American violence.",
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/coldblood.jpg"
)
book42 = Book.create!(
    :title => "Blood Meridian",
    :author => "Cormac McCarthy",
    :description => "An epic novel of the violence and depravity that attended America's westward expansion, Blood Meridian brilliantly subverts the conventions of the Western novel and the mythology of the 'wild west.' Based on historical events that took place on the Texas-Mexico border in the 1850s, it traces the fortunes of the Kid, a fourteen-year-old Tennesseean who stumbles into the nightmarish world where Indians are being murdered and the market for their scalps is thriving.",
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/bloodmeridian.jpg"
)
book43 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/sherlock.jpg"
)
book44 = Book.create!(
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/princessbride.jpg"
)
book1 = Book.create!(
    :title => "Ulysses",
    :author => "James Joyce",
    ...
    :cover_img => "https://s3-us-west-2.amazonaws.com/shouldreads-public/ulysses.jpg"
)
